...
const file_proto_presence_presence_proto_rawDesc = "" +
	"\n" +
	"\x1dproto/presence/presence.proto\x12\bpresence\x1a\x1fgoogle/protobuf/timestamp.proto\"/\n" +
...
var (
	...
	file_proto_presence_presence_proto_rawDescData []byte
)

func file_proto_presence_presence_proto_rawDescGZIP() []byte {
	file_proto_presence_presence_proto_rawDescOnce.Do(func() {
		file_proto_presence_presence_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_presence_presence_proto_rawDesc), len(file_proto_presence_presence_proto_rawDesc)))
	})
	return file_proto_presence_presence_proto_rawDescData
}

var file_proto_presence_presence_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
func file_proto_presence_presence_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_presence_presence_proto_rawDesc), len(file_proto_presence_presence_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
