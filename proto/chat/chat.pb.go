...
func (x *TypingEvent) GetRecipientId() string {
	if x != nil {
...
type ReadReceipt struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SenderId      string                 `protobuf:"bytes,1,opt,name=sender_id,json=senderId,proto3" json:"sender_id,omitempty"`          // User who read the message
	RecipientId   string                 `protobuf:"bytes,2,opt,name=recipient_id,json=recipientId,proto3" json:"recipient_id,omitempty"` // User who sent the original message
...
func (x *ReadReceipt) GetSenderId() string {
	if x != nil {
		return x.SenderId
	}
	return ""
...
func (x *ReadReceipt) GetRecipientId() string {
	if x != nil {
		return x.RecipientId
	}
	return ""
...
const file_proto_chat_chat_proto_rawDesc = "" +
	"\n" +
	"\x15proto/chat/chat.proto\x12\x04chat\x1a\x1fgoogle/protobuf/timestamp.proto\"j\n" +
...
var file_proto_chat_chat_proto_goTypes = []any{
	(*TypingEvent)(nil),               // 0: chat.TypingEvent
	(*ReadReceipt)(nil),               // 1: chat.ReadReceipt
	(*SendMessageRequest)(nil),        // 2: chat.SendMessageRequest
	(*SendMessageResponse)(nil),       // 3: chat.SendMessageResponse
	(*GetMessageHistoryRequest)(nil),  // 4: chat.GetMessageHistoryRequest
	(*GetMessageHistoryResponse)(nil), // 5: chat.GetMessageHistoryResponse
